...
class PurchaseDetailTest < ActiveSupport::TestCase
  test "Should not save purchase detail without data" do
    ...
    assert_not purchaseDetail.valid?, "The purchase detail was not valid. Errors: #{purchaseDetail.errors.to_a.to_sentence}"
  end
  ...
  test "Should not save purchase detail without material" do
    ...
    assert_not purchaseDetail.valid?, "The purcahase detail was not valid. Errors: #{purchaseDetail.errors.to_a.to_sentence}"
  end
