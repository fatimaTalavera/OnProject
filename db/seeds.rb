...
# Clientes
@client = Client.new(name: "Alex", last_name: "Jines", ruc: 4159522, email: "abel.oalex@gmail.com", adress: "Calle Zoilo San Miguel C/ Gregorio Domanmchuk", phone:"0985833038")
@client.save
...
# Facturas de compra
@purchaseBill = PurchaseBill.new(number: 123, provider_id: @provider.id, date: '30/03/2017')
@purchaseBill.save
